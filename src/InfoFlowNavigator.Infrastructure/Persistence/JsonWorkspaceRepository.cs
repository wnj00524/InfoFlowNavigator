        ...
        DateTimeOffset UpdatedAtUtc)
    {
        ...
        public EventParticipant ToDomain() =>
            new(
                ...
                EventId,
                EntityId,
                Category ?? EventParticipant.InferCategory(Role),
                string.IsNullOrWhiteSpace(RoleDetail)
                    ? EventParticipant.InferRoleDetail(Role, Category ?? EventParticipant.InferCategory(Role))
                    : RoleDetail,
                Confidence,
                Notes,
                CreatedAtUtc,
